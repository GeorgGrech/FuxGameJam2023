...
public class Health : MonoBehaviour
{
    ...
    private Fighter fighter; // Reference to the Fighter script in the entity.
    ...
    private void Start()
    {
        ...
        // Get a reference to the Fighter script in the entity.
    ...
    public void TakeDamage(int damage)
    {
        ...
        {
            // Don't take damage when defending.
            return;
        }
